...
public class RulerCaculator {
    ...
    public RulerCaculator(int width, int height, float rulerWidth,
    ...
    public static Point pointf2Point(PointO pointf) {
        if (pointf != null) {
    ...
    public static List<Point> pointfs2Points(List<PointO> pointfs) {
        if (pointfs != null) {
            List<Point> points = new ArrayList<>();
            for (PointO ptf : pointfs) {
