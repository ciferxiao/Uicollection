...
import com.cifer.uicollection.R;

import java.util.Objects;


/**
 * Created by cifer on 2018/7/6 16:48.
 */
public class PassWordEditText extends android.support.v7.widget.AppCompatEditText{
    ...
    public void addPW(String pw){
        if(!TextUtils.isEmpty(pw)){
            pw = Objects.requireNonNull(getText()).toString().trim()+pw;
    ...
    public void removePW(){
        String pw = Objects.requireNonNull(getText()).toString().trim();
        if(TextUtils.isEmpty(pw)){
            return;
        }
